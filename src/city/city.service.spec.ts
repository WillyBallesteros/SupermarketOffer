...
describe('CityService', () => {
  ...
  it('findOne should return a city by id', async () => {
    ...
    expect(city.numHabitants).toEqual(storedCity.numHabitants);
  });
  ...
  it('create should return a new city', async () => {
    ...
    expect(storedCity.numHabitants).toEqual(newCity.numHabitants);
  });
  ...
  it('update should modify a city', async () => {
    ...
    expect(storedCity.numHabitants).toEqual(city.numHabitants);
  });
